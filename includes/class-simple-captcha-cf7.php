...
wpcf7_add_form_tag( array( 'simplecaptcha', 'simplecaptcha*' ), array( $this, 'render' ), array( 'name-attr' => true ) );
}
...
$token = isset( $_POST['scaptcha_token'] ) ? wp_unslash( $_POST['scaptcha_token'] ) : null; // phpcs:ignore WordPress.Security.NonceVerification
$input = isset( $_POST['scaptcha_input'] ) ? wp_unslash( $_POST['scaptcha_input'] ) : null; // phpcs:ignore WordPress.Security.NonceVerification
